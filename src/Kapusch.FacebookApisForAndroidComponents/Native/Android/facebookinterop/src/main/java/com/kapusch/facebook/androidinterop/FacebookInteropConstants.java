...
public final class FacebookInteropConstants {
	public static final String EXTRA_STATUS = "kfb_status";
	public static final String EXTRA_ACCESS_TOKEN = "kfb_access_token";
	...
	private FacebookInteropConstants() {}
}
